...
import illVision from "@/assets/ill-vision.png";
...
const VisionSection = ({ bigGoal, threeYearVision, onBigGoalChange, onThreeYearVisionChange }: VisionSectionProps) => (
  <div className="space-y-4">
    <div className="flex items-center gap-3 mb-1">
      <img src={illVision} alt="Vision" className="w-10 h-10 object-contain" />
    ...
    <div>
      ...
      <Textarea
        ...
        className="mt-1.5 resize-none bg-background/50 border-border/50 focus:border-primary/50 min-h-[72px]"
      />
    </div>
    <div>
